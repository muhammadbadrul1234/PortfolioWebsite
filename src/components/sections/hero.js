...
<<<<<<< HEAD
  ...
  const four = (
    <p align="justify">
      I'm a Bangladesh based developer with a goal-driven creative mindset and passion for learning
      and innovating. I'm Studying Computer Science & Engineering at{' '}
      <a href="https://www.lus.ac.bd/" target="_blank" rel="noreferrer">
        Leading University
      </a>
      . I am a passoinate programmer. I started my programing career at the begining of the 2nd year
      of my University. Currently, I’m focused on learning Javascript, React and Flutter.
    </p>
=======
  const one = <h1>Hi, My Name is</h1>;
  const two = <h2 className="big-heading">Muhammad Badrul</h2>;
...
>>>>>>> 1adbda0500141b89e515ef3a09fe96def52a4493
  );
  const five = (
    <a
